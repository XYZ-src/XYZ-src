...
const string strMessageMagic = "xyzcoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
            ...
            int64_t nSubsidy = 23 * COIN; //Miner reward

            if(nBestHeight == 0)
            {
            nSubsidy = 536666 * COIN; //Total premine coin
            }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "xyzcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "26April2017";
        CTransaction txNew;
        txNew.nTime = 1493225727;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1493225727;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 3530234 : 2348932;
        ...
        assert(block.hashMerkleRoot == uint256("0xf9a36a6db3ecf8a34d7d1edfd2e9db5c83d8e25da7a65b2f214cf8d2a62a05b8"));
